...
import { AddInterestReceivedInfo } from "./AddDataForm/AddInterestReceivedInfo";

export const InterestReceived = () =>{
  ...
  const handleShowBtn = (action: boolean) => {
    ...
    return (
        <>
          <h3>Interest Received During The Year</h3>
          ...
          {showAddNew && (
        <AddInterestReceivedInfo handleShowBtn={handleShowBtn} type="Add Interest Received Info"/>
      )}
        </>
      );
}