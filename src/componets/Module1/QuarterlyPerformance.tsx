        ...
        >
          ...
          <div style={{ marginTop: "10px" }}>
            ...
            <input
              ...
              style={{ marginBottom: "10px" ,marginTop:"15px",marginRight:"90px"}}
            />
            <div>
              </div>
            <div style={{ marginTop: "10px", marginRight: "10px",float:"right"}}>
              <button
                ...
                style={{ backgroundColor: "white", borderWidth: "0", marginRight: '50px',marginTop:"10px"}}
              >
                <i
                  style={{
                    fontSize: "25px",
              ...
              {allActivity.map((val, index) => {
                ...
                return (
                  <tr key={index}>
                    ...
                    <td style={{ textAlign: "center" }}>{info.value}% {info.isUp ? <i style={{ color: 'green', textAlign: 'center' }} className="fa-solid fa-arrow-trend-up fa-fade"></i> : <i style={{ color: 'red', textAlign: 'center' }} className="fa-solid fa-arrow-trend-down fa-fade"></i>}</td>
