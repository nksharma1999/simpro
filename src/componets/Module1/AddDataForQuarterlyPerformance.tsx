...
export const AddDataForQuarterlyPerformance: React.FC<props> = ({
  closeAddComponent,
}) => {
  const [selectedFY, setselectedFY] = useState("2023");
  const [selectedTY, setselectedTY] = useState("2022");
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="form-floating mb-3">
                  ...
                  />
                  <label htmlFor="floatingInput1">Q1 FY{selectedFY}</label>
                </div>
              </div>
              <div className="col-lg-6 col-md-12">
                <div className="form-floating mb-3">
                  <input
                    ...
                    // ref={valuetInput}
                  />
                  <label htmlFor="floatingPassword3">Q2 FY{selectedFY}</label>
                </div>
              </div>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="form-floating mb-3">
                  ...
                  />
                  <label htmlFor="floatingPassword5">Q3 FY{selectedFY}</label>
                </div>
              </div>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="form-floating mb-3">
                  ...
                  />
                  <label htmlFor="floatingPassword7">Q4 FY{selectedFY}</label>
                </div>
              </div>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="form-floating mb-3">
                  <input
                    ...
                    ref={winningProbabilityInput}
                  />
                  <label htmlFor="floatingPassword9"> FY{selectedTY}</label>
                </div>
              </div>
              <div className="col-lg-6 col-md-12">
                <div className="form-floating mb-3">
                  <input
                    ...
                    ref={winningProbabilityInput}
                  />
                  <label htmlFor="floatingPassword10"> FY{selectedFY}</label>
                </div>
              </div>
            </div>
